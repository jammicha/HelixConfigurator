  ...
  <div className="adapt-card">
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-tiny text-gray-500 mb-2">The viewer lives at <code className="font-mono">http://localhost:8765/otel-data</code>. If you ticked <em>&ldquo;Expose it at localhost:8765&rdquo;</em> back in the Generate step, it&apos;s reachable directly — just open it. Otherwise it&apos;s internal (ClusterIP); port-forward to it:</p>
        <SnippetBlock text={`kubectl port-forward svc/helix-viewer 8765:8765 -n ${namespace.trim() || 'default'}`} />
        <p className="text-tiny text-gray-500 -mt-4">…then open <code className="font-mono">http://localhost:8765/otel-data</code>.</p>
      </div>
      <div>
