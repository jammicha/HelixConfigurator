...
export const StepZero: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-1000 text-gray-100 flex flex-col">
      ...
      {/* Main Content */}
      <main className="max-w-4xl w-full mx-auto px-6 py-4 space-y-4 flex-1 overflow-y-auto">
        <header className="space-y-1">
          <h1 className="text-xl font-semibold">Start from zero</h1>
        ...
        <section className="rounded-lg border border-gray-800 bg-gray-1000 p-4">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-8 h-8 rounded bg-gray-900 border border-gray-800 flex items-center justify-center">
              <Boxes className="w-4 h-4 text-blue-300" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
              <div className="text-[10px] uppercase tracking-wider text-blue-300 mb-0.5">Real apps, real SDKs</div>
              <h2 className="text-sm font-semibold text-gray-100 mb-1">Try the OpenTelemetry demo against Helix</h2>
              <p className="text-xs text-gray-400 mb-2 leading-relaxed">
                ...
                <code className="font-mono text-[11px] bg-gray-900 border border-gray-800 rounded px-1.5 py-0.5 text-gray-200">
              ...
              >
                Set up the OpenTelemetry demo <ExternalLink className="w-3.5 h-3.5" />
              </a>
            </div>
          </div>
        </section>

        <footer className="pt-2 border-t border-gray-800 flex items-center justify-between">
          <a
            href="/"
            className="inline-flex items-center gap-1.5 text-xs text-gray-300 hover:text-gray-100"
          >
            Continue to the full wizard <ArrowRight className="w-3.5 h-3.5" />
          </a>
        </footer>
      </main>
    </div>
